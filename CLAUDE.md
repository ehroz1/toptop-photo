...
- После каждой готовой правки: `npm run check` и `npm test` должны пройти,
  ...
  сначала починить.
- Владелец не программист и **не знает английского**: все сообщения ему —
  только на русском, простыми словами (включая итоговые отчёты и
  инструкции). Английский — только в коде, коммитах и PR.
